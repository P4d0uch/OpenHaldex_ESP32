...
//                 packet.data[6] = SERIAL_PACKET_END;
//  */
//             Serial.printf("APP_MSG_STATUS %d  haldex_state %d haldex_engagement %d lock_target %d vehicle_speed %d state.mode_override %d )\n",
//                     packet.data[1],
//                     packet.data[2],
//                     packet.data[3],
//                     packet.data[4],
//                     packet.data[5]);
//             //Serial.printf(packet.data, packet.len);
// #endif
//         }
//     }
// }
